...
const HealthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 mt-14 lg:mt-0">
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl p-6 lg:p-8 mb-6 text-white shadow-xl">
        <div className="flex items-start justify-between">
          ...
          <div className="w-12 h-12 bg-white/20 backdrop-blur rounded-2xl flex items-center justify-center lg:w-16 lg:h-16 lg:rounded-3xl">
            <Stethoscope className="w-6 h-6 lg:w-6 lg:h-8" />
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h2 className="text-xl font-semibold text-gray-800">
              {filteredRecords.length} {labels[activeTab]}
              {filteredRecords.length !== 1 ? "s" : ""} registrada
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl p-8 shadow text-center">
            ...
            <p className="text-gray-600 mb-6">
              {emptyMessages[activeTab].split(".")[1] ||
