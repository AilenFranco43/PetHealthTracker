// src/components/health/HealthRecordDetailSkeleton.jsx
        ...
        <div className="relative z-10">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-2 self-start lg:self-center">
              {[1, 2, 3].map((i) => (
                <div key={i} className="w-10 h-10 bg-gray-400/70 rounded-xl"></div>
              ))}
            </div>
          </div>
              ...
              <div className="p-8">
                ...
                <div className="pt-8 border-t border-gray-100">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i} className="bg-gradient-to-br from-gray-50 to-white p-5 rounded-xl border border-gray-100">
